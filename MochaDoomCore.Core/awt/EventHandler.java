...
public enum EventHandler : EventBase<EventHandler>
{
    ...
    EventHandler(Consumer<RelationMapper<EventHandler>> relationMapper)
    {
        ...
        cooperations = Collections.emptyMap();
    ...
    EventHandler(int eventId, ActionMode... enableModes)
    {
        this(eventId, null, enableModes);
    }
    EventHandler(int eventId, Consumer<ActionMapper<EventHandler>> actionMapper, ActionMode... enableModes)
    {
        this.eventId = eventId;
        actions = new EnumMap<>(ActionMode.class);
        enabled = EnumSet.noneOf(ActionMode.class);
        enabled.addAll(Arrays.asList(enableModes));

        adjustments = new EnumMap<>(RelationType.class);
        cooperations = new EnumMap<>(RelationType.class);
