...
public class DoomMain<T, V> extends DoomStatus<T, V> implements IDoomGameNetworking, IDoomGame, IDoom
{
     ...
     * DOOM II Par Times
     */
    private final int[] cpars = {
            30, 90, 120, 120, 90, 150, 120, 120, 270, 90,    //  1-10
            210, 150, 150, 150, 210, 150, 420, 150, 210, 150,    // 11-20
            240, 150, 180, 150, 150, 300, 330, 420, 300, 180,    // 21-30
            120, 30                  // 31-32
    };
    private final DoomSystemNetworking systemNetworking;
    private final Finale<T> finale;
    private final EndLevel<T, V> endLevel;
    ...
    private boolean[] nodeingame = new boolean[MAXNETNODES];        // set false as nodes leave game
    private boolean[] remoteresend = new boolean[MAXNETNODES];      // set when local needs tics
    ...
    private int ticdup;
    // _D_
    private boolean reboundpacket = false;
    private doomdata_t reboundstore = new doomdata_t();
    private StringBuilder exitmsg = new StringBuilder(80);
    private int gametime;
    private boolean[] gotinfo = new boolean[MAXNETNODES];
    private int frameon;
    private boolean[] frameskip = new boolean[4];
    ...
    private void Display()
    {
        ...
        do
        {
            ...
            wipestart = nowtime;
            var wipeType = CM.equals(Settings.scale_melt, Boolean.TRUE)
     ...
     */
    @D_Main.C(D_DoomLoop)
    private void DoomLoop() throws IOException
    {
        if (demorecording)
        {
            BeginRecording();
     ...
     * @return
     */
    private boolean CheckForLumps(String[] name, WadLoader W)
    {
        for (var name1 : name)
        {
     ...
     * @throws IOException
     */
    private void ArbitrateNetStart() throws IOException
    {
        int i;
        autostart = true;
