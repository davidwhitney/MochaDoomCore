...
public interface Lights extends Colors
{
    ...
    default int[][] BuildLights24(int[] palette, byte[][] colormap)
    {
        ...
        int[] color0 = new int[3], color1 = new int[3], color2 = new int[3];
    ...
    {
        float luminance = GreyscaleFilter.component((float) rgb[0], rgb[1], rgb[2]);
        int grey = (int) (255 * (1.0 - luminance / PAL_NUM_COLORS));
