...
public interface Colors
{
     ...
     */
    default int[] tintRGB888(ColorTint tint, int[] rgbInput, int[] rgbOutput)
    {
     ...
     */
    default int[] tintRGB555(ColorTint tint, int[] rgbInput, int[] rgbOutput)
    {
    ...
    {
        long distance = ColorDistance888(rgb888_1, rgb888_2);
    ...
    {
        int r1 = getRed(rgb888_1);
        int g1 = getGreen(rgb888_1);
        int b1 = getBlue(rgb888_1);
        int r2 = getRed(rgb888_2);
        int g2 = getGreen(rgb888_2);
        int b2 = getBlue(rgb888_2);
    ...
    {
        long distance = ColorDistanceHSV888(rgb888_1, rgb888_2);
        return distance > 0 ? 1 : distance < 0 ? -1 : 0;
    }
    ...
    {
        int r1 = (int) (0.21 * getRed(rgb888_1));
        int g1 = (int) (0.72 * getGreen(rgb888_1));
        int b1 = (int) (0.07 * getBlue(rgb888_1));
        int r2 = (int) (0.21 * getRed(rgb888_2));
        int g2 = (int) (0.72 * getGreen(rgb888_2));
        int b2 = (int) (0.07 * getBlue(rgb888_2));
    ...
    {
        long distance = ColorDistance555(rgb555_1, rgb555_2);
        return distance > 0 ? 1 : distance < 0 ? -1 : 0;
    }
    ...
    {
        int r1 = getRed5(rgb1);
        int g1 = getGreen5(rgb1);
        int b1 = getBlue5(rgb1);
        int r2 = getRed5(rgb2);
        int g2 = getGreen5(rgb2);
        int b2 = getBlue5(rgb2);
    ...
    {
        long distance = ColorDistanceHSV555(rgb555_1, rgb555_2);
        return distance > 0 ? 1 : distance < 0 ? -1 : 0;
    }
    ...
    {
        int r1 = (int) (0.21 * getRed5(rgb555_1));
        int g1 = (int) (0.72 * getGreen5(rgb555_1));
        int b1 = (int) (0.07 * getBlue5(rgb555_1));
        int r2 = (int) (0.21 * getRed5(rgb555_2));
        int g2 = (int) (0.72 * getGreen5(rgb555_2));
        int b2 = (int) (0.07 * getBlue5(rgb555_2));
    ...
    default int BestColor(int r, int g, int b, int[] palette, int rangel, int rangeh)
    {
        ...
        {
            long dr = r - getRed(palette[i]);
            long dg = g - getGreen(palette[i]);
            long db = b - getBlue(palette[i]);
            long distortion = dr * dr + dg * dg + db * db;
