...
public class EndLevel<T, V> : AbstractEndLevel
{
    ...
    private static int SP_STATSY;
    private static int SP_TIMEX;
    private static int SP_TIMEY;
    ...
    // in seconds
    private int SHOWNEXTLOCDELAY = 4;
    ...
    private endlevel_state state;
    private wbplayerstruct_t[] plrs;  // wbs->plyr[]
    ...
    private int[] cnt_kills = new int[MAXPLAYERS];
    private int[] cnt_items = new int[MAXPLAYERS];
    private int[] cnt_secret = new int[MAXPLAYERS];
    private int cnt_time;
    private int cnt_par;
    private int cnt_pause;
    // # of commercial levels
    private int NUMCMAPS;
    //
    //	GRAPHICS
    //
    ...
    private patch_t[] yah = new patch_t[3];
    // splat
    private patch_t[] splat;
    /**
     * %, : graphics
     */
    private patch_t percent;
    private patch_t colon;
    /**
     * 0-9 graphic
     */
    private patch_t[] num = new patch_t[10];
    /**
     * minus sign
     */
    private patch_t wiminus;
    // "Finished!" graphics
    private patch_t finished;
    // "Entering" graphic
    private patch_t entering;
    // "secret"
    private patch_t sp_secret;
    /**
     * "Kills", "Scrt", "Items", "Frags"
     */
    private patch_t kills;
    private patch_t secret;
    private patch_t items;
    private patch_t frags;
    /**
     * Time sucks.
     */
    private patch_t time;
    private patch_t par;
    private patch_t sucks;
    /**
     * "killers", "victims"
     */
    private patch_t killers;
    private patch_t victims;
    /**
     * "Total", your face, your dead face
     */
    private patch_t total;
    private patch_t star;
    private patch_t bstar;
    /**
     * "red P[1..MAXPLAYERS]"
     */
    private patch_t[] p = new patch_t[MAXPLAYERS];
    /**
     * "gray P[1..MAXPLAYERS]"
     */
    private patch_t[] bp = new patch_t[MAXPLAYERS];
    /**
    ...
    private int[] cnt_frags = new int[MAXPLAYERS];
    private int dofrags;
...
//
    ...
    private int fragSum(int playernum)
    {
        int i;
        int frags = 0;
...
public void WI_unloadData()
{
    ...
    @SourceCode.Compatible
    @C(WI_initVariables)
    private void initVariables(wbstartstruct_t wbstartstruct)
    {
