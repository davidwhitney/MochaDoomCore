...
public class Finale<T>
{
    ...
    public void TextWrite()
    {
        ...
        int cx = 10, cy = 10;
        char[] ch = finaletext.toCharArray();
    ...
    public void CastTicker()
    {
        ...
        } else
        {
            ...
            statenum_t st = caststate.nextstate;
            ...
            if (sfx != null)
            {// Fixed mute thanks to _D_ 8/6/2011
    ...
    public void CastDrawer()
    {
        ...
        patch_t patch = DOOM.wadLoader.CachePatchNum(lump + DOOM.spriteManager.getFirstSpriteLump());
    ...
    {
        patch_t p1 = DOOM.wadLoader.CachePatchName("PFUB2", PU_LEVEL);
        patch_t p2 = DOOM.wadLoader.CachePatchName("PFUB1", PU_LEVEL);
            ...
            switch (DOOM.gameepisode)
            {
                case 1:
                    if (DOOM.isCommercial() || DOOM.isRegistered())
                        DOOM.graphicSystem.DrawPatchScaled(FG, DOOM.wadLoader.CachePatchName("CREDIT", PU_CACHE), DOOM.vs, 0, 0);
                    else
                        // Fun fact: Registered/Ultimate Doom has no "HELP2" lump.
                        DOOM.graphicSystem.DrawPatchScaled(FG, DOOM.wadLoader.CachePatchName("HELP2", PU_CACHE), DOOM.vs, 0, 0);
                    break;
                case 2:
                    DOOM.graphicSystem.DrawPatchScaled(FG, DOOM.wadLoader.CachePatchName("VICTORY2", PU_CACHE), DOOM.vs, 0, 0);
                    break;
                case 3:
                    BunnyScroll();
                    break;
                case 4:
                    DOOM.graphicSystem.DrawPatchScaled(FG, DOOM.wadLoader.CachePatchName("ENDPIC", PU_CACHE), DOOM.vs, 0, 0);
                    break;
            }
        }
