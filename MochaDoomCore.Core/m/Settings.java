...
public enum Settings
{
    ...
    Settings(Files config, String defaultValue)
    {
        this.defaultValue = defaultValue;
    ...
    Settings(Files config, char defaultValue)
    {
        this.defaultValue = defaultValue;
    ...
    Settings(Files config, long defaultValue)
    {
        this.defaultValue = defaultValue;
        valueType = Long.class;
        configBase = config;
    }
    Settings(Files config, double defaultValue)
    {
        this.defaultValue = defaultValue;
