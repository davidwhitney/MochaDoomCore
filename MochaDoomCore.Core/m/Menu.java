...
public class Menu<T, V> : AbstractDoomMenu<T, V>
{
    ...
    private void initMenuItems()
    {
        ...
        OptionsDef = new menu_t(opt_end, MainDef, OptionsMenu, DrawOptions, 60, 37, 0);
    ...
    {
        return StringHeight(string.toCharArray());
    }
    ...
    public bool Responder(event_t ev)
    {
        ...
        } else if (sc == SC_F5 && DOOM.ticker instanceof DelegateTicker)
        { // Toggle ticker
    ...
    class M_ChangeDetail : MenuRoutine
    {
        ...
        public void invoke(int choice)
        {
            ...
            DOOM.sceneRenderer.SetViewSize(screenblocks, detailLevel);
            if (detailLevel == 0) DOOM.players[DOOM.consoleplayer].message = DETAILHI;
            else DOOM.players[DOOM.consoleplayer].message = DETAILLO;
