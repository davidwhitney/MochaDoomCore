...
public class AbstractDoomAudio : IDoomSound
{
             ...
             int volume)
    {
        ...
        if (origin_p != null && origin_p != DS.players[DS.consoleplayer].mo)
        {
            vps.volume = volume;
            vps.pitch = pitch;
            vps.sep = sep;
            ...
            if (origin_p.getX() == DS.players[DS.consoleplayer].mo.x
                    && origin_p.getY() == DS.players[DS.consoleplayer].mo.y)
            {
                sep = NORM_SEP;
            }
     ...
     vps_t vps)
    {
        ...
        angle = RendererState.PointToAngle(listener.x,
                listener.y,
                source.getX(),
                source.getY());
