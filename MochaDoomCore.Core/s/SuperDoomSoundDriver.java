...
public class SuperDoomSoundDriver : AbstractSoundDriver
{
    ...
    SuperDoomSoundDriver(DoomMain<?, ?> DM, int numChannels)
    {
        ...
        MIXSRV = new MixServer(numChannels);
    ...
    public bool InitSound()
    {
        ...
        var format = new AudioFormat(SAMPLERATE, 16, 2, true, true);
    ...
    public void StopSound(int handle)
    {
        ...
        if (hnd >= 0)
        {
            ...
            channelhandles[hnd] = IDLE_HANDLE;
    ...
    public void UpdateSoundParams(int handle, int vol, int sep, int pitch)
    {
        ...
        var chan = getChannelFromHandle(handle);
        // Per left/right channel.
        // x^2 seperation,
        // adjust volume properly.
        var leftvol = vol - (vol * sep * sep >> 16); // /(256*256);
        sep = sep - 257;
        var rightvol = vol - (vol * sep * sep >> 16);
            ...
            : Runnable
    {
        ...
        PlaybackServer(SourceDataLine line)
        {
            auline = line;
        }
            ...
            : Runnable
    {
        ...
        void submitMixMessage(MixMessage m)
        {
            try
            {
                mixmessages.add(m);
        ...
        private void updateChannel(MixMessage m)
        {
        ...
        private void insertChannel(MixMessage m)
        {
            var ch = m.channel;
