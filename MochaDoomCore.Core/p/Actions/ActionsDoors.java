...
public interface ActionsDoors extends ActionsMoveEvents, ActionsUseEvents
{
    ...
    default void VerticalDoor(vldoor_t door)
    {
        switch (door.direction)
        {
            ...
            {
                // DOWN
                result_e res = MovePlane(door.sector, door.speed, door.sector.floorheight, false, 1, door.direction);
            ...
            case 1:
                // UP
                result_e res = MovePlane(door.sector, door.speed, door.topheight, false, 1, door.direction);
