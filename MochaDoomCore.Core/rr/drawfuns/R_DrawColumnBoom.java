        ...
        : DoomColumnFunction<T, V>
{
            ...
            : R_DrawColumnBoom<byte[], short[]>
    {
        ...
        public void invoke()
        {
            ...
            byte[] source = dcvars.dc_source;
            short[] colormap = dcvars.dc_colormap;
            ...
            : R_DrawColumnBoom<byte[], byte[]>
    {
        ...
        public void invoke()
        {
            ...
            byte[] source = dcvars.dc_source;
            byte[] colormap = dcvars.dc_colormap;
            int heightmask = dcvars.dc_texheight - 1;
            if ((dcvars.dc_texheight & heightmask) != 0) // not a power of 2
            // --
            // killough
            ...
            : R_DrawColumnBoom<byte[], int[]>
    {
        ...
        public void invoke()
        {
            ...
            byte[] source = dcvars.dc_source;
            int[] colormap = dcvars.dc_colormap;
            int heightmask = dcvars.dc_texheight - 1;
            if ((dcvars.dc_texheight & heightmask) != 0) // not a power of 2
            // --
            // killough
